...
$(window).load(function() {
	...
	*/ 
	...
	$(function() {
		...
		var $menuPage1 = $(".menu__page1").isotope({
			itemSelector: ".menu-page__item"
		});

		// Set ititial filtering
		$menuPage1.isotope({ filter: ".menu_meals" });

		// Filrter items on click
		
		$(".menu__nav1 > li > a").click(function(e) {

			// Filter items 
			var filterValue = $(this).attr('data-filter');
			$menuPage1.isotope({ filter: filterValue });
			// Change active button
			$(this).parents("li").addClass("active").siblings("li").removeClass("active");
	...
	$(function() {
		...
		// Init Isotope
		var $menuPage2 = $(".menu__page2").isotope({
			itemSelector: ".menu-page__item"
		});
		
		$menuPage2.isotope({ filter: ".menu_apples" });

		// Filrter items on click
		$(".menu__nav2 > li > a").click(function(e) {

			// Filter items 
			var filterValue = $(this).attr('data-filter');
			$menuPage2.isotope({ filter: filterValue });
	...
	$(function() {
		...
		$('#lang_app').text(languages[theLanguage]);
